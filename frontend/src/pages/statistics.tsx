...
import {
  ...
  PieChart, Pie, Cell, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Radar, ScatterChart, Scatter
} from 'recharts';
import { 
  fetchSensorData, 
  fetchWeatherHistory, 
              ...
              <div className="lg:col-span-3">
                ...
                <div className="w-full h-[400px]">
                    ...
                    <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                        ...
                        />
                        <YAxis type="number" dataKey="soil_moisture" name="Soil Moisture (%)" unit="%" />
